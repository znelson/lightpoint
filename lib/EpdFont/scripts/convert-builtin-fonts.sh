...
COURIERPRIME_FONT_SIZES=(12 14 16 18)
...
for size in ${COURIERPRIME_FONT_SIZES[@]}; do
  for style in ${READER_FONT_STYLES[@]}; do
    font_name="courierprime_${size}_$(echo $style | tr '[:upper:]' '[:lower:]')"
    font_path="../builtinFonts/source/CourierPrime/CourierPrime-${style}.ttf"
    output_path="../builtinFonts/${font_name}.h"
